...
class TesUploadController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        // $form_data = array(
        // 'product_name'       =>   $request->product->toArray(),
        // 'description'        =>   $request->description->toArray(),
        // 'image'            =>   $new_name->toArray(),
        // 'type' => $request->type->toArray(),
        // 'price' => $request->price->toArray()
        // );
        // DB::table('products')->insert($form_data);
        // Product::insert($form_data);
