<!-- Hero Section Begin -->
<section class="hero spad set-bg" data-setbg="/assets/img/gelang-bg.jpg">
    <div class="container">
        <!-- <div class="row">
                <div class="col-lg-7">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    ...
                    <h2>Produk Kami</h2>
                    <p>Produk-produk yang kami jual.</p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="feature__text">
                    ...
                    <div class="feature__text__desc">
                        <p>Menyediakan segala jenis Geang Rubber, Masker</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                            ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo
                            viverra maecenas accumsan lacus vel facilisis.</p>
                    </div>
                    <div class="feature__text__btn">
                        <a href="{{ url('/about') }}" class="primary-btn">Tentang Kami</a>
                        {{-- <a href="#" class="primary-btn partner-btn">Partner Kami</a> --}}
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="filter__controls">
                    <li class="active" data-filter="*">Paling dicari</li>
                    <li data-filter=".sale">Penjualan Terbaru</li>
                </ul>
            </div>
        </div>
                ...
                <div class="car__item">
                    ...
                    <div class="car__item__text">
                        <div class="car__item__text__inner">
                            <div class="label-date">{{ $p->created_at }}</div>
