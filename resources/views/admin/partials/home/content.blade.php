                ...
                <div class="row mt-4">
                    <div class="col-xl-3 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">{{ $users }} Admin</div>
                            </div>
                    ...
                    <div class="col-xl-3 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">{{ $products }} Stok Produk</div>
                            </div>
                    ...
                    <div class="col-xl-3 mb-3">
                        <div class="card text-white bg-success o-hidden h-100">
                            <div class="card-body">
                                <div class="card-body-icon">
                                    <i class="fad fa-fw fa-clipboard-list"></i>
                                </div>
                                <div class="mr-5">Produk Terjual</div>
                            </div>
                                            ...
                                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    <img class="media-object rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-5.jpg"
                                                ...
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    class="avatar pull-up">
                                                    <img class="media-object rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-7.jpg"
                                                        alt="Avatar" height="30" width="30">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    class="avatar pull-up">
                                                    <img class="media-object rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-10.jpg"
                                                        alt="Avatar" height="30" width="30">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    class="avatar pull-up">
                                                    <img class="media-object rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-8.jpg"
                                                        alt="Avatar" height="30" width="30">
                                                </li>
                                            </ul>
                                        </td>
                                        ...
                                        <td class="p-1">
                                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    class="avatar pull-up">
                                                    <img class="media-object rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-1.jpg"
                                                        alt="Avatar" height="30" width="30">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    class="avatar pull-up">
                                                    <img class="media-object rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-2.jpg"
                                                        alt="Avatar" height="30" width="30">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    class="avatar pull-up">
                                                    <img class="media-object rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-3.jpg"
                                                        alt="Avatar" height="30" width="30">
                                                </li>
                                            </ul>
                                        </td>
                                        ...
                                        <td class="p-1">
                                            <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    class="avatar pull-up">
                                                    <img class="media-object rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-6.jpg"
                                                        alt="Avatar" height="30" width="30">
                                                </li>
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    data-placement="bottom" data-original-title="Elicia Rieske"
                                                ...
                                                <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    class="avatar pull-up">
                                                    <img class="media-object rounded-circle"
                                                        src="/admin/app-assets/images/portrait/small/avatar-s-9.jpg"
                                                        alt="Avatar" height="30" width="30">
                                                </li>
                                            </ul>
                                        </td>
